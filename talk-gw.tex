...
***one-component reliability plot???
\end{frame}
...
\uncover<1->{\node at (0,0) %
     {\parbox{\textwidth}{\begin{multline*}
       \Rsys\left( t \mid \{\nktzg,\yktzr,\vec{t}^k\}^{1:K} \right) = P\left(\Tsys > t \mid \cdots \right)\\
